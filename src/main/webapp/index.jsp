...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" content="child-src 'self' data: gap: https://*.salesforce.com https://*.documentforce.com 'unsafe-eval'; default-src 'self' data: gap: https://*.salesforce.com https://*.documentforce.com 'unsafe-eval';  style-src * self 'unsafe-inline' blob: data: gap: https://*.salesforce.com https://*.documentforce.com 'unsafe-inline'; script-src * 'self' 'unsafe-eval' 'unsafe-inline' blob: data: gap: https://*.salesforce.com https://*.documentforce.com; object-src * 'self' blob: data: gap:; img-src * self 'unsafe-inline' blob: data: gap:; connect-src self * 'unsafe-inline' blob: data: gap:; frame-src 'self' data: gap: https://*.salesforce.com https://*.documentforce.com 'unsafe-eval'; base-uri * self 'unsafe-inline' blob: data: gap:;">
