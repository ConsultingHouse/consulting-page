...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" content="child-src https://login.salesforce.com https://*.documentforce.com https://consultinghouse.my.salesforce.com 'unsafe-eval'; default-src 'self' data: gap: https://login.salesforce.com https://*.documentforce.com https://consultinghouse.my.salesforce.com 'unsafe-eval';  style-src * self 'unsafe-inline' blob: data: gap: https://login.salesforce.com https://*.documentforce.com https://consultinghouse.my.salesforce.com 'unsafe-inline'; script-src * 'self' 'unsafe-eval' 'unsafe-inline' blob: data: gap: https://login.salesforce.com https://*.documentforce.com; object-src * 'self' blob: data: gap:; img-src * self 'unsafe-inline' blob: data: gap:; connect-src self * 'unsafe-inline' blob: data: gap:; frame-src https://login.salesforce.com https://*.documentforce.com https://consultinghouse.my.salesforce.com 'unsafe-eval'; base-uri * self 'unsafe-inline' blob: data: gap:;">
