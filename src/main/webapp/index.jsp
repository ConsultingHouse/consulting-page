...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" content="child-src * 'unsafe-inline' 'unsafe-eval'; default-src * 'unsafe-inline' 'unsafe-eval'; style-src 'self' 'unsafe-inline'; media-src *; script-src 'self' https://*.salesforce.com 'unsafe-inline' 'unsafe-eval'; ">
