...
<head>
    ...
    <meta http-equiv="Content-Security-Policy" charset="UTF-8" content="frame-ancestors 'self' *.salesforce.com ; default-src 'self' data: gap: * 'unsafe-eval'; style-src 'self' 'unsafe-inline'; media-src *;**script-src 'self' * 'unsafe-inline' 'unsafe-eval';** report-uri * width=device-width, user-scalable=no">
